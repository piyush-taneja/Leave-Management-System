...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>MIND | Employee Leave Management Portal | Home Page</title>
    ...
    <body background="assets/images/background.jpg">
        ...
        <div class="mn-content fixed-sidebar">
                ...
                <nav class="cyan darken-1">
                    <div class="nav-wrapper row">
                        ...
                        <div class="header-title col s3">      
                            <span class="chapter-title">MIND | Employee Leave Management Portal</span>
                        </div>
          ...
          <div class="footer">
                    <p class="copyright"><a href="piyushtaneja.taneja@gmail.com">MIND </a>©</p>
            ...
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title"><h4 style="color:red">Welcome to MIND Employee Leave Management Portal</h4></div>
                                  ...
                                  <div class="card-content ">
                                      <span class="card-title" style="font-size:20px;">Employee Login</span>
                                       ...
                                       <div class="row">
                                           ...
                                           <div class="conatiner" style="margin-left:20px">
                                
                                              <h6 style="font-weight: bold;">For Demo use </h6>
                                              <h6 style="font-weight: bold;">User Name: piyushtaneja.taneja@gmail.com</h6>
                                              <h6 style="font-weight: bold;">Password: ppp</h6>
