...
$CL=$CL+$LeaveCount;
       ...
       if($LeaveType=='CL')
        ...
        $sql="UPDATE tblemployees SET CL=:cl WHERE EmailId=:email ";
        $query = $dbh->prepare($sql);
...
else if($LeaveType=='PL')
{
  ...
  $msg=$PL;
        ...
        $sql="UPDATE tblemployees SET PL=:pl WHERE EmailId=:email ";
        $query = $dbh->prepare($sql);
...
$sql = "SELECT tblleaves.id as lid,tblemployees.FirstName,tblemployees.LastName,tblemployees.EmpId,tblemployees.CL,tblemployees.PL,tblemployees.id,tblemployees.Gender,tblemployees.Phonenumber,tblemployees.EmailId,tblleaves.LeaveType,tblleaves.ToDate,tblleaves.FromDate,tblleaves.LeaveCount,tblleaves.Description,tblleaves.PostingDate,tblleaves.Status,tblleaves.AdminRemark,tblleaves.AdminRemarkDate from tblleaves join tblemployees on tblleaves.empid=tblemployees.id where tblleaves.id=:lid";
$query = $dbh -> prepare($sql);
...
{         
      ?>  
                                        ...
                                        <tr>
                                          ...
                                          <tr>
                                            ...
                                            <td><input  name="EmailId" id="EmailId" value="<?php echo htmlentities($result->EmailId);?>" type="text" autocomplete="off" readonly required> </td>
  ...
  <tr>
                                            ...
                                            <td><input  name="LeaveType" id="LeaveType" value="<?php echo htmlentities($result->LeaveType);?>" type="text" autocomplete="off" readonly required></td>
                                            <td style="font-size:16px;"><b>Days Leave Applied for:</b></td>
                                            <td><input  name="LeaveCount" id="LeaveCount" value="<?php echo htmlentities($result->LeaveCount);?>" type="text" autocomplete="off" readonly required> </td>
                                            <td style="font-size:16px;"><b>Remaining PL:</b></td>
                                            <td><input  name="PL" id="PL" value="<?php echo htmlentities($result->PL);?>" type="text" autocomplete="off" readonly required></td>
                                            <td style="font-size:16px;"><b>Remaining CL:</b></td>
                                            <td><input  name="CL" id="CL" value="<?php echo htmlentities($result->CL);?>" type="text" autocomplete="off" readonly required></td>
...
<input  name="LeaveType" id="LeaveType" value="<?php echo htmlentities($result->LeaveType);?>" type="text" autocomplete="off" readonly required> 
</div>
<div class="input-field col  s12">
<label for="LeaveCount"></label>
<input  name="LeaveCount" id="LeaveCount" value="<?php echo htmlentities($result->LeaveCount);?>" type="text" autocomplete="off" readonly required> 
</div>
<div class="input-field col  s12">
<label for="CL"></label>
...
<div class="input-field col  s12">
<label for="PL"></label>
<input  name="PL" id="PL" value="<?php echo htmlentities($result->PL);?>" type="text" autocomplete="off" readonly required> 
</div>
<br><br>
