...
$sql="INSERT INTO tblemployees(EmpId,FirstName,LastName,EmailId,Password,Gender,Dob,Department,Address,City,Country,Phonenumber,Status,PL,CL) VALUES(:empid,:fname,:lname,:email,:password,:gender,:dob,:department,:address,:city,:country,:mobileno,:status,:PL,:CL)";
...
<input id="phone" name="mobileno" type="tel" maxlength="10" autocomplete="off" required>
      ...
      <div class="input-field col m6 s12">
<label for="CL">Add CL Leaves</label>
<input id="CL" name="CL" type="text" maxlength="1" autocomplete="off" required>
 </div>

 <div class="input-field col m6 s12">
<label for="PL">Add PL Leaves</label>
<input id="PL" name="PL" type="text" maxlength="1" autocomplete="off" required>
 </div>
